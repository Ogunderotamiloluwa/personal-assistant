    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:bg-gray-900 dark:text-white">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-6">
            <div className="flex items-center gap-3 flex-shrink-0 w-full sm:w-auto">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-2xl sm:text-3xl font-semibold text-gray-900 dark:text-white truncate">Routines</h1>
                <p className="text-sm text-gray-500 dark:text-gray-400 hidden sm:block">Organize and automate your daily schedule</p>
              </div>
            </div>
            <motion.button
              whileHover={{ scale: 1.05 }}
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 md:py-8">
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 mb-8">
          ...
          >
            <div className="text-sm text-gray-600 dark:text-gray-400 mb-2">Total Routines</div>
            <div className="text-2xl sm:text-3xl font-bold text-blue-600 dark:text-blue-400">{routines.length}</div>
          </motion.div>
          ...
          <motion.div
            ...
            className="p-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700"
          >
            <div className="text-sm text-gray-600 dark:text-gray-400 mb-2">Today's Routines</div>
            <div className="text-2xl sm:text-3xl font-bold text-indigo-600 dark:text-indigo-400">{todayRoutines.length}</div>
        ...
        {loading ? (
          ...
          >
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-3">No routines yet</h2>
            <p className="text-gray-500 dark:text-gray-400 text-base mb-6 max-w-md mx-auto">Create your first routine to automate your daily schedule!</p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
          ...
          <>
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">All Routines</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <AnimatePresence>

      ...
      >
        ...
        <div className="p-6 md:p-8 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-2xl backdrop-blur-sm">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-2">Sign In</h1>
            <p className="text-sm text-gray-600 dark:text-gray-400">Welcome back to your assistant</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            >
              <button
                ...
                className="text-xs text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors cursor-pointer font-medium"
              >
                Forgot password?
              </button>
            </motion.div>
          ...
          <div className="my-6 flex items-center gap-3">
            ...
            <span className="text-xs text-gray-500 dark:text-gray-400">New here?</span>
            <div className="h-px flex-1 bg-gray-200 dark:bg-gray-700" />
          </div>
          ...
          >
            <button
              ...
              className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-semibold transition-colors cursor-pointer"
            >
              Create an account
            </button>
          </motion.div>
